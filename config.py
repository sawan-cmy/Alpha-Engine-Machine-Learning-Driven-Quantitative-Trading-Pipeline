...
UNIVERSE = [
    ...
    'BAJAJFINSV.NS', 'M&M.NS', 'ONGC.NS', 'WIPRO.NS', 'NTPC.NS',
    'JSWSTEEL.NS', 'POWERGRID.NS', 'ADANIENT.NS', 'INDUSINDBK.NS', 'NESTLEIND.NS',
    'GRASIM.NS', 'TECHM.NS', 'HDFCLIFE.NS', 'SBILIFE.NS', 'BAJAJ-AUTO.NS',
    'DRREDDY.NS', 'BRITANNIA.NS', 'COALINDIA.NS', 'CIPLA.NS', 'APOLLOHOSP.NS'
]
